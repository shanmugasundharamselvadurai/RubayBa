...
{
    public class PaymentSuccessfulViewModel : MvxViewModel<dynamic>
    {
        private readonly IMvxNavigationService _navigationService;

        public PaymentSuccessfulViewModel(IMvxNavigationService navigationService)
        {
        ...
        public override void Prepare(dynamic companyWalletTransaction)
        {
            ...
            TransactionDateTime = companyWalletTransaction.CreatedDateTimeUtc.AddHours(5).AddMinutes(30);
            TransNo = TransNo;
            
            //TransactionDateTime = DateTime.UtcNow.AddHours(5).AddMinutes(30);
        }
