...
{
    public class OTPVerificationPageViewModel : MvxViewModel<string>
    {
        ...
        public OTPVerificationPageViewModel(IMvxNavigationService navigationService, IUserDialogs userDialogs)
        {
